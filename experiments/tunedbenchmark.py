...
# Title: COMPACTION
def experiment_4_compaction():
    n_individuals = 2500
    n_snps = 200
    print(f"--- [Exp 4: COMPACTION] Optimizing for Genomic Depth ---")

    # THE TUNING: Compact Modulus Chain for Depth=1
    # Dropping from [60,40,40,60] to [40, 21, 40]
    ...
    serialized_size = len(enc_rows[0].serialize()) / 1024 # KB
